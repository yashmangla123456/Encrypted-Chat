  ...
  return (function (t) {
      ...
      function r(t, e) {
        ...
        return (
          l
            ...
            : (u[p] || (c("new io instance for %s", s), (u[p] = a(s, e))),
              (n = u[p])),
    ...
    function (t, e) {
      (function (e) {
        function n(t) {
          return (
            (r && e.Buffer.isBuffer(t)) ||
            (o && (t instanceof e.ArrayBuffer || i(t)))
          );
        }
        t.exports = n;
        var r =
          ...
          i = (function () {
            return o && "function" == typeof e.ArrayBuffer.isView
      ...
      (t.exports = r),
        ...
        (r.prototype.onopen = function () {
          h("open"),
            ...
            this.emit("open");
          var t = this.engine;
          this.subs.push(u(t, "data", p(this, "ondata"))),
            this.subs.push(u(t, "ping", p(this, "onping"))),
            this.subs.push(u(t, "pong", p(this, "onpong"))),
            this.subs.push(u(t, "error", p(this, "onerror"))),
            this.subs.push(u(t, "close", p(this, "onclose"))),
            this.subs.push(u(this.decoder, "decoded", p(this, "ondecoded")));
        }),
        ...
        function r(t, n) {
          ...
          (n = n || {}),
            ...
            t
              ...
              : n.host && (n.hostname = p(n.host).host),
            (this.secure =
              null != n.secure
                ? n.secure
        ...
        function r(e) {
          ...
          if (t.location) {
            var u = "https:" === location.protocol,
              p = location.port;
            p || (p = u ? 443 : 80),
              (r = e.hostname !== location.hostname || p !== e.port),
              (a = e.secure !== u);
          }
          if (
            ((e.xdomain = r),
        ...
        (e.encodePacket = function (e, n, i, a) {
          ...
          (e.encodeBase64Packet = function (n, r) {
            ...
            try {
              ...
              for (
                var c = new Uint8Array(n.data), u = new Array(c.length), p = 0;
                p < c.length;
                p++
              )
                u[p] = c[p];
          ...
          (e.decodePayloadAsBinary = function (t, n, r) {
            ...
            for (var o = t, i = []; o.byteLength > 0; ) {
              for (
                var s = new Uint8Array(o), a = 0 === s[0], c = "", u = 1;
                255 !== s[u];
                u++
              ) {
      ...
      s(r.prototype),
        (r.prototype.subEvents = function () {
          if (!this.subs) {
            var t = this.io;
            this.subs = [
              c(t, "open", u(this, "onopen")),
              c(t, "packet", u(this, "onpacket")),
              c(t, "close", u(this, "onclose")),
            ];
          }
        }),
        (r.prototype.open = r.prototype.connect =
